...
function Radio({
  ...
  return (
    <button
      type="button"
      onClick={onSelect}
      className={`cursor-pointer flex w-full items-center gap-3 rounded-full border px-4 py-3 text-left text-sm transition-all ${
        checked
          ? "border-[#6B9FE8] bg-[#6B9FE8]/10"
          : "border-[#e8e8e4] bg-[#f7f7f5] hover:border-[#d4d4d0]"
      }`}
    >
      <span
        className={`grid h-4 w-4 shrink-0 place-items-center rounded-full border transition-colors ${
          checked ? "border-[#6B9FE8]" : "border-zinc-400 bg-white"
        }`}
      >
        {checked && <span className="h-2 w-2 rounded-full bg-[#6B9FE8]" />}
      </span>
      <span className="flex-1 text-[#1a1a1a] font-medium">{children}</span>
    </button>
  );
}
...
export default function CampaignBuilder({ mode, campaignId }: CampaignBuilderProps) {
    ...
    return (
      <div className="panel rounded p-8 text-center">
        ...
        <button
          ...
          className="cursor-pointer mt-4 rounded border border-border px-4 py-2 text-sm text-muted hover:text-foreground"
        >
          Back to campaigns
        </button>
      </div>
  ...
  return (
    <div className="-mx-4 lg:-mx-8 -my-5 sm:-my-6 flex min-h-[calc(100dvh-3.75rem-env(safe-area-inset-top))]">
      {importQueue && (
        <div className="shrink-0 rounded border border-accent/30 bg-accent/5 px-4 py-3 text-sm">
      ...
      {/* LEFT: normal flow — outer main handles scrolling */}
      <div className="flex-1 min-w-0 px-4 lg:px-8 py-6 space-y-8">
        ...
        <div className="space-y-3">
          <label className="block text-sm font-bold mb-2" style={{ fontFamily: "'Comfortaa', sans-serif", color: "#1a1a1a" }}>
            Campaign name{" "}
          ...
          <input
            ...
            className="w-full rounded-2xl border border-[#e8e8e4] bg-[#f7f7f5] px-4 py-2.5 text-sm text-[#1a1a1a] placeholder:text-[#a0a0a0] shadow-sm focus:outline-none transition-all"
            maxLength={100}
          />
          {accounts.length > 1 && (
            <div className="pt-2">
        ...
        <Section title="And this comment has">
          ...
          <div className="rounded-2xl border border-[#e8e8e4] bg-[#f7f7f5] p-4 transition-all">
              ...
              <div className="mt-4 space-y-3 border-t border-[#e8e8e4] pt-4">
                {publicReplyMessages.map((msg, i) => (
                  <div key={i} className="flex items-center gap-2">
                    <input
                      ...
                      maxLength={1000}
                      className="w-full rounded-2xl border border-[#e8e8e4] bg-[#ffffff] px-4 py-2.5 text-sm text-[#1a1a1a] placeholder:text-[#a0a0a0] shadow-sm focus:outline-none transition-all"
                    />
                    {publicReplyMessages.length > 1 && (
                      <button
                        ...
                        className="cursor-pointer shrink-0 px-2 text-[#a0a0a0] hover:text-[#dc2626] transition-colors"
                ...
                {publicReplyMessages.length < 10 && (
                  <button
                    ...
                    className="cursor-pointer text-xs font-semibold text-[#6B9FE8] hover:underline"
                  >
                    + Add another reply
                  </button>
                )}
        ...
        <Section title="They will get">
          <div className="rounded-2xl border border-[#e8e8e4] bg-[#f7f7f5] p-4 transition-all">
            <div className="flex items-center justify-between gap-3">
              <span className="text-sm font-semibold text-[#1a1a1a]">an opening DM</span>
              <Toggle
                on={openingDmEnabled}
            ...
            {openingDmEnabled && (
              <div className="mt-4 space-y-3 border-t border-[#e8e8e4] pt-4">
                <textarea
                  ...
                  rows={3}
                  className="w-full rounded-2xl border border-[#e8e8e4] bg-[#ffffff] px-4 py-2.5 text-sm text-[#1a1a1a] placeholder:text-[#a0a0a0] shadow-sm focus:outline-none transition-all resize-none"
                  maxLength={1000}
                />
                <input
          ...
          <div className="mt-3 rounded-2xl border border-[#e8e8e4] bg-[#f7f7f5] p-4 transition-all">
            <div className="flex items-center justify-between gap-3">
              <span className="text-sm font-semibold text-[#1a1a1a]">
        ...
        <Section title="And then, they will get">
          <div className="rounded-2xl border border-[#e8e8e4] bg-[#f7f7f5] p-4 transition-all">
            <span className="block mb-3 text-sm font-semibold text-[#1a1a1a]">a DM with a link</span>
            <div className="space-y-3">
              <textarea
                value={dmMessage}
              ...
              {linkOpen ? (
                <div className="space-y-3">
                  ...
                  />
                  {secondLinkOpen ? (
                    <div className="space-y-3 border-t border-[#e8e8e4] pt-3">
                      <input
            ...
            {followUpEnabled && (
              <div className="mt-4 space-y-3 border-t border-[#e8e8e4] pt-4">
                ...
                <div className="flex flex-wrap items-center gap-2 text-sm text-[#1a1a1a]">
                  <span className="text-xs text-[#a0a0a0]">Send it</span>
                  <input
                    type="number"
                    min={0}
                    max={1440}
                    ...
                    className="w-20 rounded-xl border border-[#e8e8e4] bg-[#ffffff] px-3 py-1.5 text-sm text-[#1a1a1a] shadow-sm focus:outline-none transition-all"
                  />
        ...
        <div className="flex flex-wrap items-center gap-3 pt-4 border-t border-border">
          ...
          <button
            ...
            onClick={skipRow}
            disabled={saving}
            className="cursor-pointer rounded-full border border-border px-5 py-2.5 text-sm font-medium text-muted hover:text-foreground disabled:opacity-50 disabled:cursor-default"
          >
        ...
        <button
          ...
          disabled={saving}
          className="cursor-pointer rounded-full px-6 py-2.5 text-sm font-semibold text-white disabled:opacity-50 transition-all disabled:cursor-default"
          style={{
            background: "#6B9FE8",
            boxShadow: "0 2px 8px rgb(107 159 232 / 0.35)",
          }}
        >
        ...
        {/* RIGHT: sticky preview — sticks to outer main scroll container */ }
  <div
    ...
    style={{
      ...
      height: "calc(100dvh - 3.75rem - env(safe-area-inset-top) - 3rem)",
      overflow: "hidden",
    }}
  >
    <CampaignPreview

...
Instagram DM automation platform for comment-to-DM workflows.

[![License: MIT](https://img.shields.io/badge/License-MIT-black.svg)](LICENSE)
[![Stars](https://img.shields.io/github/stars/shreyasgurav/Nudge?style=flat&color=black)](https://github.com/shreyasgurav/Nudge/stargazers)
[![Built with Next.js](https://img.shields.io/badge/Next.js-16-black.svg)](https://nextjs.org)

</div>

Someone comments `LINK` on your reel, and they get a DM with your link a second later. That is the whole idea. Nudge watches the comments on your Instagram posts, and when a comment matches a keyword you set, it sends that person a private reply through the official Meta API. You can also post a public reply under the comment at the same time.

Nudge is a self-hosted Instagram automation platform with no seat limits and no plan caps.

> **Nudge is self-hosted. You deploy your own copy.**
>
...
> If this saves you time or money, a star on the repo genuinely helps other people find it.
...
Nudge is built around Meta's official Instagram private replies. It does not scrape, it does not automate a browser, and it never asks for an Instagram password. That keeps your account inside Meta's rules, which matters if you care about not getting flagged.
...
2. Meta sends a webhook to your Nudge instance.
3. Nudge checks the text against your active campaigns.
...
[![Deploy with Vercel](https://vercel.com/button)](https://vercel.com/new/clone?repository-url=https://github.com/shreyasgurav/Nudge)

### Run it locally

```bash
git clone https://github.com/shreyasgurav/Nudge.git
cd Nudge
npm install
...
Built and maintained by Shreyas Gurav.

- GitHub: [@shreyasgurav](https://github.com/shreyasgurav)
- Instagram: [@bluehourhq](https://instagram.com/bluehourhq)

Nudge was forked from [OpenReply](https://github.com/diwenne/openreply) by [Diwen Huang](https://github.com/diwenne), which was initially forked from [instagram-comment-to-dm](https://github.com/im-anishraj/instagram-comment-to-dm) by [Anish Raj](https://github.com/im-anishraj). All MIT licensed.

## Star the repo

If Nudge is useful to you, star it. It is the simplest way to help the project reach the next person looking for Instagram automation.
